...
# 기존 테이블에 현대적인 스타일 적용하기
# def modernize_table(table, radius=10, app_font_name='NanumSquare'):
#     """
#     기존 테이블에 둥근 모서리와 그림자 효과를 적용합니다.
#     """
#     # 테이블 스타일 적용
